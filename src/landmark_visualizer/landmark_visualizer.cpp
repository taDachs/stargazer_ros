...
int main(int argc, char** argv) {
  ...
  for (auto& el : landmarks) {
    ...
    marker.ns = "Landmarks";
    marker.pose.position.x = stargazer::Landmark::kGridDistance *
                             (stargazer::Landmark::kGridCount / 2. - 1. / 2.);
    marker.pose.position.y = stargazer::Landmark::kGridDistance *
                             (stargazer::Landmark::kGridCount / 2. - 1. / 2.);
    ...
    text_marker.pose.position.x = stargazer::Landmark::kGridDistance *
                                  (stargazer::Landmark::kGridCount / 2. - 1. / 2.);
    text_marker.pose.position.y = stargazer::Landmark::kGridDistance *
                                  (stargazer::Landmark::kGridCount / 2. - 1. / 2.);
