...
ReprojectionVisualizer::ReprojectionVisualizer(ros::NodeHandle node_handle,
  ...
  message_filters::TimeSynchronizer<stargazer_ros_tool::LandmarkArray, geometry_msgs::PoseStamped, sensor_msgs::Image> sync(
  ...
  foreach (rosbag::MessageInstance const m, view) {
    ...
    if (m.isType<stargazer_ros_tool::LandmarkArray>()) {
      stargazer_ros_tool::LandmarkArray::ConstPtr lm_msg =
...
void ReprojectionVisualizer::synchronizerCallback(
    const stargazer_ros_tool::LandmarkArray::ConstPtr& lm_msg,
